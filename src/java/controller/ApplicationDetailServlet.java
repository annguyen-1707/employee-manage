...
public class ApplicationDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Application a = adao.getById(applicationId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int processedBy = employee.getEmployeeId();

        ApplicationDAO adao = new ApplicationDAO();
        if (action.equals("accept")) {
            adao.approveApplication(applicationId, processedBy, note);
        } else if (action.equals("reject")) {
            adao.rejectApplication(applicationId, processedBy, note);
        }
        response.sendRedirect("applicationDetail?applicationId=" + applicationId);
    }
